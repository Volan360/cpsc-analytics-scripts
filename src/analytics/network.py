...
class NetworkAnalytics:
    ...
    def analyze(
        ...
        Args:
            ...
            graph_type: Type of graph to analyze ('financial_flow', 'goal_institution', 'tag_network')
        ...
        elif graph_type == 'goal_institution':
            graph = self.build_goal_institution_graph(institutions, goals)
        elif graph_type == 'tag_network':
    ...
    def build_goal_institution_graph(
        ...
        for goal in goals:
            ...
            # Add edges with allocation percentages
            for inst_id, percentage in goal.linked_institutions.items():
                inst_node = f"inst_{inst_id}"
                if inst_node in G:
                    G.add_edge(
